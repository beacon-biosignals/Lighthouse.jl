...
@testset "`Lighthouse.area_under_curve`" begin
    ...
    @test isapprox(Lighthouse.area_under_curve(collect(0:0.01:1), collect(0:0.01:1)), 0.5, atol=0.01)
    @test isapprox(Lighthouse.area_under_curve(collect(0:0.01:2π), sin.(0:0.01:2π)), 0.0, atol=0.01)
end
...
@testset "`Lighthouse.area_under_curve_unit_square`" begin
    ...
    @test isapprox(Lighthouse.area_under_curve_unit_square(collect(0:0.01:1), collect(0:0.01:1)), 0.5, atol=0.01)
    @test isapprox(Lighthouse.area_under_curve_unit_square(collect(0:0.01:2π), sin.(0:0.01:2π)), 0.459, atol=0.01)
end
